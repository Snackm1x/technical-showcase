...
import { ShoppingListContainer, InputArea, ShoppingList } from './components';
...
describe('ShoppingListContainer', () => {
    ...
    it('passes a bound addItem function to InputArea', () => {
        ...
        expect(wrapper.state('beers')).to.eql(['Apples']);
    });

    it('renders the items', () => {
        const wrapper = mount(<ShoppingListContainer/>);
        wrapper.instance().addItem('Apples');
        wrapper.instance().addItem('Peaches');
...
describe('InputArea', () => {
    ...
    it('should accept input', () => {
        ...
        expect(input.prop('value')).to.equal('Peaches');
    });
